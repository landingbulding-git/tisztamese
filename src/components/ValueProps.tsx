        ...
        <div className="grid md:grid-cols-3 gap-8">
          {props.map((p, idx) => {
            const images: Record<string, string> = {
              ...
              "Intuitív alkotás": "https://pmfyfnpyhiyhb9bc.public.blob.vercel-storage.com/alkot%C3%A1s.jpg",
              "Szimbólumfejtés": "https://pmfyfnpyhiyhb9bc.public.blob.vercel-storage.com/szimbolumfejtes.jpg"
            };
