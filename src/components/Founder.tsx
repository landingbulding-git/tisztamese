      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <p className="text-brand-primary font-bold text-[10px] mb-4 uppercase tracking-[0.3em]">Az útitársad</p>
            <h2 className="text-5xl md:text-7xl mb-8 italic leading-[0.9]">Barcza Katalin – A belső labirintusban</h2>
            <div className="space-y-6 text-xl opacity-70 leading-relaxed font-light">
              <p>
