...
const faqData: FAQSection[] = [
  {
    ...
    items: [
      ...
      {
        question: "Szükség van-e segítőre a meseterápiához, vagy a mese önmagában is működik?",
        answer: "Bár a segítőnek kell egyfajta tudás ahhoz, hogy lássa, az adott embernek milyen szimbólumok lesznek hasznosak az élethelyzete megmozdításához, a mese önmagában, spontán is elvégzi a dolgát. Erre példa, amikor a kisgyerekek ösztönösen ugyanazt a mesét kérik újra és újra, mert abban van valami, ami megerősíti őket. A tudattalan lassú munkájához a mese szelíd és mély változást hoz, de ez nem egy csettintésre történik meg. A segítő abban támogat, hogy a folyamat végén meg lehessen beszélni, kinek mit jelentenek ezek a belső szimbólumok."
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "Részt vehetek-e az eseményen, ha egyáltalán nem tudok rajzolni?",
  ...
  },
  {
    ...
    items: [
      {
        question: "Reflektálhatnak-e a résztvevők egymás rajzaira az online eseményen?",
        answer: "Nem, ezen az online eseményen a csoporttagoknak nem lesz lehetőségük egymás alkotásaira reflektálni, kizárólag én fogok beszélgetni azzal, aki ezt önként vállalja. A személyes csoportokkal ellentétben az online térben az emberi jelenlét hiánya miatt nem lehet könnyen érvényesíteni a reflexió szigorú szempontjait."
      },
      {
        question: "Mit adhat a részvétel annak, akinek a rajzára nem jut idő, vagy nem akar megszólalni?",
