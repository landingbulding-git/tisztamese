...
export const Closer = () => {
  return (
    <section className="py-12 md:py-24 relative overflow-hidden bg-gradient-to-br from-brand-bg via-brand-bg/80 to-brand-primary/70">
      {/* Magical Glows */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-white">
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] mb-4 opacity-60">A lehetőség</p>
            <h2 className="text-6xl md:text-8xl mb-8 leading-[0.9] italic">Készen állsz a saját mesédre?</h2>
            
            <div className="grid sm:grid-cols-2 gap-6 mb-10">
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-3xl border border-white/10">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center mb-3">✓</div>
